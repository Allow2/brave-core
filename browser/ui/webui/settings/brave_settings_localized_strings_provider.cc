...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"braveParentalFreedom", IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_TITLE},
      {"braveParentalFreedomDescription",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_DESCRIPTION},
      {"braveParentalFreedomEnableLabel",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_ENABLE_LABEL},
      {"braveParentalFreedomPairingStatus",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_PAIRING_STATUS},
      {"braveParentalFreedomPaired",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_PAIRED},
      {"braveParentalFreedomNotPaired",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_NOT_PAIRED},
      {"braveParentalFreedomStartPairing",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_START_PAIRING},
      {"braveParentalFreedomCancelPairing",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_CANCEL_PAIRING},
      {"braveParentalFreedomEnterPin",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_ENTER_PIN},
      {"braveParentalFreedomSelectChild",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_SELECT_CHILD},
      {"braveParentalFreedomSwitchUser",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_SWITCH_USER},
      {"braveParentalFreedomBlockingStatus",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_BLOCKING_STATUS},
      {"braveParentalFreedomAllowed",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_ALLOWED},
      {"braveParentalFreedomBlocked",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_BLOCKED},
      {"braveParentalFreedomRemainingTime",
       IDS_SETTINGS_BRAVE_PARENTAL_FREEDOM_REMAINING_TIME},
